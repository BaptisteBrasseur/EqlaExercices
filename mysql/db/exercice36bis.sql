...
CREATE DATABASE blindcode3 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE blindcode3;
...
CREATE TABLE eleve (
                       ...
                       registre_national varchar(20) UNIQUE NOT NULL,
                       is_actif boolean NOT NULL DEFAULT 1,
                       nationalite varchar(20) NOT NULL,
                       rue varchar(50) NOT NULL,
                       numero varchar(5) NULL,
                       boite_postale varchar(3) NULL,
...
CREATE TABLE eleve_formation (
                                ...
                                CONSTRAINT fk_eleve_id FOREIGN KEY(eleve_id) REFERENCES eleve(id),
                                CONSTRAINT fk_formation_id FOREIGN KEY(formation_id) REFERENCES formation(id)
);
...
/* Eleve BlindCode BXL */
INSERT INTO eleve (nom,prenom,date_naissance,registre_national,is_actif,nationalite,rue,numero,boite_postale,code_postal,localite,sexe,email,telephone,gsm)
...
INSERT INTO eleve (nom,prenom,date_naissance,registre_national,is_actif,nationalite,rue,numero,boite_postale,code_postal,localite,sexe,email,telephone,gsm)
VALUES ('Brasseur','Baptiste','1996-09-22','96092219758',1,'Belge','Place de Fayt','5',NULL,'7387','Honnelles','M','baptistebrasseur@yahoo.fr','065634295','0473623742');
